...
const schedule = [
  { time: "9:00", label: "Сборы у жениха", desc: "" },
  { time: "15:30", label: "Фуршет", desc: "Шампанское и канапе" },
  { time: "18:00", label: "Свадебный ужин", desc: "Праздник при свечах" },
  { time: "21:00", label: "Танцы", desc: "Музыка и веселье" },
]
        ...
        <div className="grid md:grid-cols-2 gap-16">
          ...
          <div className="flex flex-col gap-12">
            ...
            <FadeIn delay={0.1} blur>
              <div
                className="border-l-2 border-foreground/12 pl-8"
                style={{
              ...
              >
                ...
                <p className="font-serif font-light text-3xl text-foreground mb-1">
                  Суббота, 3 октября
                </p>
              ...
              <div>
                ...
                <ul className="flex flex-col gap-0">
                  {schedule.map((item) => (
                    <li
                      key={item.time}
                      className="flex items-start gap-6 py-4 border-b border-border last:border-0"
                      style={{
                    ...
                    >
                      <span className="font-sans text-xs text-muted-foreground w-12 shrink-0 pt-0.5">
                        {item.time}
                      </span>
                      <div>
          ...
          <FadeIn delay={0.15} blur>
            <div className="flex flex-col gap-5">
              <div className="border-l-2 border-foreground/12 pl-8 mb-2">
                ...
                <p className="font-serif font-light text-xl text-foreground">
                  Площадка торжества
                </p>
                <p className="font-sans text-sm text-muted-foreground mt-1">
                  Нажмите на фото, чтобы открыть в картах
                </p>
              </div>

              {/* Clickable venue photo */}
              <a
                href="https://yandex.ru/maps/org/sid_kholl/226809495458/?ll=43.106396%2C44.043269&z=16"
                target="_blank"
              ...
              >
                <Image
                  ...
                  alt="Ресторан для свадебного ужина"
                  fill
              ...
              <a
                ...
                style={{
                  transition:
                    "color 0.4s ease, border-color 0.4s ease, transform 0.4s cubic-bezier(0.22,1,0.36,1)",
                }}
                onMouseEnter={(e) => {
                  const el = e.currentTarget as HTMLAnchorElement
                  el.style.color = "var(--foreground)"
                  el.style.borderColor = "oklch(var(--foreground) / 0.5)"
